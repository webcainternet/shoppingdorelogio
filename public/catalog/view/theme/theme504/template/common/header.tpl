...
$.src="//v2.zopim.com/?3DYIEuNbQeyA38HUZR45k2hXxvHSTUSu";z.t=+new Date;$.
...
<header>
	<div class="container">
		<div id="logo">
			<?php if ($logo) { ?>
			<a href="<?php echo $home; ?>"><img width="130" style="width: 150px;" src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" class="img-responsive" /></a>
			<?php } else { ?>
